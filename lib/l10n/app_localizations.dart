...
abstract class AppLocalizations {
  ...
  /// No description provided for @noRoomsForBooking.
  ///
  /// In en, this message translates to:
  /// **'There are no rooms for booking yet'**
  String get noRoomsForBooking;

  /// No description provided for @roomCapacityNumber.
  ///
  /// In en, this message translates to:
  /// **'Room capacity'**
  ...
  /// No description provided for @roomIsActiveStatus.
  ///
  /// In en, this message translates to:
  /// **'Room is active'**
  ...
  /// No description provided for @roomSelectImage.
  ///
  /// In en, this message translates to:
  /// **'Select image'**
  ...
  /// No description provided for @bookingSheduleError.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t get a schedule'**
  String get bookingSheduleError;

  /// No description provided for @retryOrLater.
  ///
  /// In en, this message translates to:
