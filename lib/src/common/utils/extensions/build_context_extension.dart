...
extension ContextExtension on BuildContext {
  ...
  T? inheritedMaybeOf<T extends InheritedWidget>({bool listen = true}) => listen
  ...
  /// or the widget goes away), this build context is rebuilt so that it can
  /// obtain new values from that widget.
  T inheritedOf<T extends InheritedWidget>({bool listen = true}) =>
      inheritedMaybeOf<T>(listen: listen) ??
      (throw ArgumentError(
